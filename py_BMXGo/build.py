...
add_checked_function(mod, 'BMXGo_BMXAdapter_SearchAugmentedMany2', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'queries'), param('int64_t', 'topK'), param('int64_t', 'num_augmented_queries'), param('double', 'weight'), param('int64_t', 'maxConcurrent')])
