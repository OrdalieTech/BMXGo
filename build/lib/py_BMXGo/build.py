...
mod.add_function('Map_string_Map_string_float64_CTor', retval('int64_t'), [])
mod.add_function('Map_string_Map_string_float64_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_string_Map_string_float64_elem', retval('int64_t'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Map_string_float64_contains', retval('bool'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Map_string_float64_set', None, [param('int64_t', 'handle'), param('char*', 'key'), param('int64_t', 'value')])
mod.add_function('Map_string_Map_string_float64_delete', None, [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_Map_string_float64_keys', retval('int64_t'), [param('int64_t', 'handle')])
...
mod.add_function('BMXGo_Query_F_table_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('BMXGo_Query_F_table_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('BMXGo_Query_IDF_table_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('BMXGo_Query_IDF_table_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('BMXGo_Query_E_tilde_table_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('BMXGo_Query_E_tilde_table_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('BMXGo_Query_E_table_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('BMXGo_Query_E_table_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
...
add_checked_function(mod, 'BMXGo_Query_IDF_table_fill', None, [param('int64_t', '_handle'), param('int64_t', 'bmx'), param('bool', 'goRun')])
add_checked_function(mod, 'BMXGo_Query_F_table_fill', None, [param('int64_t', '_handle'), param('int64_t', 'bmx'), param('bool', 'goRun')])
add_checked_function(mod, 'BMXGo_Query_E_tilde_table_fill', None, [param('int64_t', '_handle'), param('int64_t', 'bmx'), param('bool', 'goRun')])
add_checked_function(mod, 'BMXGo_Query_E_table_fill', None, [param('int64_t', '_handle'), param('int64_t', 'bmx'), param('bool', 'goRun')])
...
add_checked_function(mod, 'BMXGo_BMXAdapter_AddMany', None, [param('int64_t', '_handle'), param('int64_t', 'ids'), param('int64_t', 'docs'), param('bool', 'goRun')])
...
add_checked_function(mod, 'BMXGo_BMXAdapter_SearchAugmented', retval('int64_t'), [param('int64_t', '_handle'), param('char*', 'query'), param('int64_t', 'topK'), param('int64_t', 'num_augmented_queries')])
add_checked_function(mod, 'BMXGo_BMXAdapter_SearchAugmentedMany', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'queries'), param('int64_t', 'topK'), param('int64_t', 'num_augmented_queries'), param('int64_t', 'maxConcurrent')])
...
add_checked_function(mod, 'BMXGo_E_tilde', retval('double'), [param('int64_t', 'F_table'), param('char*', 'qi'), param('int64_t', 'docs')])
add_checked_function(mod, 'BMXGo_F', retval('double'), [param('char*', 'qi'), param('int64_t', 'doc')])
...
add_checked_function(mod, 'BMXGo_IDF', retval('double'), [param('char*', 'qi'), param('int64_t', 'docs')])
